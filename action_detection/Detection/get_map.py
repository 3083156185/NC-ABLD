...
if __name__ == "__main__":
    ...
    #--------------------------------------------------------------------------------------#
    classes_path    = 'model_data/wy_classes.txt'
    #--------------------------------------------------------------------------------------#
    ...
    #   结果输出的文件夹，默认为map_out
    #-------------------------------------------------------#
    map_out_path    = 'map_out/ECAdark3_focalloss'

    image_ids = open(os.path.join(VOCdevkit_path, "VOCWY/ImageSets/Main/test.txt")).read().strip().split()
    ...
    if map_mode == 0 or map_mode == 1:
        ...
        for image_id in tqdm(image_ids):
            image_path  = os.path.join(VOCdevkit_path, "VOCWY/JPEGImages/"+image_id+".jpg")
    ...
    if map_mode == 0 or map_mode == 2:
        ...
        for image_id in tqdm(image_ids):
            with open(os.path.join(map_out_path, "ground-truth/"+image_id+".txt"), "w") as new_f:
                root = ET.parse(os.path.join(VOCdevkit_path, "VOCWY/Annotations/"+image_id+".xml")).getroot()

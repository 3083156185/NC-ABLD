...
save_folder = 'J:\youda\Actionsrecognition\st_weights'
...
#   graph_node: Number of node in skeleton, Default: 9
#   channels: Inputs data (x, y and scores), Default: 3
#   num_class: Number of pose class to train, Default: 7

data_files = r'J:\youda\Data\st_data.pkl'
class_names = ['barCode', 'blCode', 'check', 'double', 'fetch', 'insert', 'overturn']
...
if __name__ == '__main__':
    ...
    # DATA.
    train_loader, _ = load_dataset(data_files, batch_size)
    valid_loader, train_loader_ = load_dataset(data_files, batch_size, 0.2)

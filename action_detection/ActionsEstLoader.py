...
class TSSTG(object):
    ...
    Args:
        weight_file: (str) Path to trained st_weights file.
        device: (str) Device to load the model on 'cpu' or 'cuda'.
    """
    def __init__(self,
                 weight_file=r'Actionsrecognition/st_weights/tsstg-model-30frame.pth',
                 device=''):
        self.graph_args = {'strategy': 'spatial'}
        self.class_names = ['stand', "walk", "run", 'climb', 'touch', 'squat']
